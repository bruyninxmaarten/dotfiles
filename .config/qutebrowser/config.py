...
config.bind('xx', 'config-cycle tabs.show never always;; config-cycle statusbar.show never always')
...
## Type: Dict
c.aliases = {'w': 'session-save', 'q': 'quit', 'wq': 'quit --save', 'wqa': 'quit --save'}
...
## Type: QssColor
c.colors.completion.item.selected.bg = '#88c0d0'

## Bottom border color of the selected completion item.
## Type: QssColor
c.colors.completion.item.selected.border.bottom = '#88c0d0'

## Top border color of the selected completion item.
## Type: QssColor
c.colors.completion.item.selected.border.top = '#88c0d0'
...
## Type: QtColor
c.colors.completion.item.selected.match.fg = '#81a1c1'

## Foreground color of the matched text in the completion.
## Type: QtColor
c.colors.completion.match.fg = '#81a1c1'
...
## Type: QssColor
c.colors.completion.scrollbar.fg = '#88c0d0'
...
## Type: QtColor
c.colors.downloads.error.bg = '#3b4252'
...
## Type: QtColor
c.colors.downloads.start.bg = '#3b4252'

## Color gradient start for download text.
## Type: QtColor
c.colors.downloads.start.fg = '#5E81AC'

## Color gradient stop for download backgrounds.
## Type: QtColor
c.colors.downloads.stop.bg = '#3b4252'
...
## Type: QssColor
c.colors.keyhint.fg = '#EBCB8B'

## Highlight color for keys to complete the current keychain.
## Type: QssColor
c.colors.keyhint.suffix.fg = '#3B4252'

## Background color of an error message.
## Type: QssColor
c.colors.messages.error.bg = '#3B4252'

## Border color of an error message.
## Type: QssColor
c.colors.messages.error.border = '#3B4252'

## Foreground color of an error message.
## Type: QssColor
c.colors.messages.error.fg = '#BF616A'
...
## Type: QssColor
c.colors.statusbar.caret.fg = '#B48EAD'
...
## Type: QssColor
c.colors.statusbar.caret.selection.fg = '#B48EAD'
...
## Type: QssColor
c.colors.statusbar.command.fg = '#88c0d0'
...
## Type: QssColor
c.colors.statusbar.command.private.fg = '#88c0d0'
...
## Type: QssColor
c.colors.statusbar.insert.fg = '#A3BE8C'
...
## Type: QssColor
c.colors.statusbar.passthrough.fg = '#5E81AC'
...
## Number of om increments to divide the mouse wheel movements to.
## Type: Int
